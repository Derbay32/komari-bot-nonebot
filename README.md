...
1. clone 这个仓库
2. 进入仓库后根据需求修改 `jrhg_config.json.example` 、 `.env.example` 等各种 .example 的文件，当然你可以选择直接运行一遍机器人让它自己生成，本质上没什么区别。
...
**大概率会做的功能**
- [ ] 记忆注入功能 - 给小鞠分四层记忆，然后动态注入到提示词里，~~纯小范围享受，人多数据量铁炸~~
