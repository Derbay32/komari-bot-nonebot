...
from komari_bot.plugins.komari_memory import api_runtime as api_runtime_module
from komari_bot.plugins.komari_memory.api import API_PREFIX
...
def test_register_management_api_for_fastapi_driver(monkeypatch: object) -> None:
    ...
    assert f"{API_PREFIX}/conversations" in route_paths
    assert any(
